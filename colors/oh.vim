" Modified Tomorrow Night - Full Colour and 256 Colour
...
if has("gui_running") || &t_Co == 88 || &t_Co == 256
	...
	if version >= 700
		...
		call <SID>X("CursorLine", s:yellow, s:line, "none")
		call <SID>X("CursorColumn", "", s:line, "none")
		call <SID>X("PMenu", s:foreground, s:selection, "none")
    call <SID>X("PmenuSel", s:yellow, s:line, "")
		call <SID>X("SignColumn", "", s:background, "none")
	end
	if version >= 703
		call <SID>X("ColorColumn", "", s:background, "none")
	end

  call <SID>X("WildMenu", "", s:yellow, "")
